<div class="container py-4">
	<div class="d-flex justify-content-between align-items-center mb-4">
		...
		<a class="btn btn-outline-secondary" href="/manager/batches">Quay lại</a>
	</div>
	...
	<?php if (empty($boxes)): ?>
	<div class="alert alert-light border text-center text-muted" role="alert">Không có dữ liệu thùng cho lô này.</div>
	<?php else: ?>
	<div class="card shadow-sm mb-4">
